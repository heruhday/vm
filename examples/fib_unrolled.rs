//! Fibonacci unrolled computation
//! Computes fib(5) = 5 by unrolling the loop
...
fn main() {
    println!("=== Fibonacci Unrolled Computation ===\n");
    println!("Computing fib(5) by unrolling...");
    ...
    builder.emit_jmp_false(255, 4); // if n > 1, skip base case
    ...
    // Manually unroll loop for i = 2 to 5
    // i = 2
